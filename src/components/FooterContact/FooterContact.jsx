...
import Background from "@/assets/footerContact/bg.jpg";

export default function FooterContact() {
    return (
        <div
            className={`${pangaiaBold.className} ${classes.footerContactContainer}`}
        >
            <Image
                className={classes.footerContactBackground}
                src={Background}
                alt="Background"
                width={60}
                height={0}
